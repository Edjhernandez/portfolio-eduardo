...
export default function Skills() {
    return ( 
      <main className="flex justify-center flex-col items-center pb-8">

        <h1 className={`${inconsolata.className} text-mark-text2 not-italic text-[32px] font-bold mt-[64px] mb-8`}>My Skills</h1>
        
        <div className={`${inconsolata.className} text-white text-2xl not-italic font-medium leading-4 w-full flex items-center flex-col gap-4`}>
          
          <div className="w-4/5 px-8 py-[14px] bg-[#21201D] flex items-center rounded-[10px] max-w-[460px]">
