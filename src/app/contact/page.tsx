...
export default function Contact() {
    return (
      <main className={`${inconsolata.className} w-full flex flex-col items-center text-text font-normal not-italic text-xl bg-[radial-gradient(circle_500px_at_50%_200px,#3e3e3e,#21201D)] pt-32 sm:pt-40 lg:h-screen lg:pt-14`}>
