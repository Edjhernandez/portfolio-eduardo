...
export function Form() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`h-5 w-full flex justify-center items-center ${inconsolata.className} text-[10px] text-mark-text1 font-bold `}
      >
      ...
      {formSpreeState.succeeded && (
        <p className="text-text mt-4 text-sm mx-4 text-center">
          Thanks for your message!
        </p>
      )}
      {formSpreeState.errors && (
        <p className="text-text mt-4 text-sm mx-4 text-center">
          Some error occurred, please try again in few minutes!
        </p>
      )}
    </form>
  );
