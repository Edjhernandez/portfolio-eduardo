...
export function Work(props: dataWork) {
  ...
  return (
    <section>
      <div
        className={`w-80 h-80 flex flex-col items-center justify-center py-4 not-italic gap-10 relative`}
      >
        <Image
          width={320}
          height={320}
        ...
        <div className="flex flex-col items-center justify-center py-4 not-italic gap-10 z-10">
          <h2 className="text-mark-text2 text-[32px] font-bol">
            {props.title}
          </h2>
          <h3 className="text-base text-text font-medium text-center mx-6">
            {props.toolsUsed}
          </h3>
      ...
      {showModal && (
        <div className="w-screen h-screen fixed top-0 left-0 z-50">
          <div className="bg-[radial-gradient(circle_500px_at_50%_200px,#3e3e3e,#21201D)] z-[999] w-[90%] border-2 border-text rounded-lg flex flex-col items-center px-4 gap-6 py-auto max-w-md absolute top-32 right-0 left-0 m-auto md:flex-row md:top-1 md:bottom-1 md:max-w-3xl md:max-h-[340px] lg:max-w-6xl lg:max-h-[540px]">
            ...
            <Link href={props.link} className="mt-24 md:my-auto">
              <Image
                width={1000}
                height={1000}
                alt="project photo"
            ...
            <div className="flex flex-col items-center gap-5">
              <h2 className="text-mark-text2 text-[32px] font-bol mt-5">
                {props.title}
              </h2>
