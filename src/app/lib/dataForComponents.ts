...
export const myWorks: dataWork[] = [
  {
    ...
    description:
      "Project done to lay the groundwork for the new Redux features, using slice reducer and API requires with createAsyncThunk",
  },
  {
    title: "Car Insurance",
    ...
    description:
      "Implementation of Web application Vehicle Insurance Quotation, with responsive features and field validation",
  },
  {
    title: "Covid Metrics",
    ...
    description:
      "Responsive design where you can filter the data by day, and select the country to details information",
  },
];
