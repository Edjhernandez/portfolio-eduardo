...
export default function Projects() {
  return (
    <main className="flex flex-col items-center pb-8 w-full bg-[radial-gradient(circle_500px_at_50%_400px,#3e3e3e,#1b1a17)] bg-no-repeat lg:h-screen">
      <h1
        className={`${inconsolata.className} text-mark-text2 not-italic text-[32px] font-bold mt-32 mb-8`}
      >
        My Works
      </h1>

      <div
        className={`${inconsolata.className} w-full not-italic leading-4 flex items-center justify-center flex-col gap-4 pb-8 lg:flex-row lg:flex-wrap max-w-[1400px]`}
      >
